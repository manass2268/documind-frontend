    ...
    <div className="min-h-screen bg-[#05050A] text-white font-sans flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center relative z-10 p-4 mt-12 md:mt-0">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-[#0B0B14]/80 backdrop-blur-xl border border-white/10 p-6 md:p-10 rounded-3xl w-full max-w-md shadow-2xl">
          ...
          <p className="text-gray-400 text-center text-sm mb-8">Join DocuMind and learn smarter</p>
          ...
          <div className="flex items-center mb-6">
            ...
            <span className="px-3 text-[10px] md:text-xs text-gray-500 uppercase tracking-wider font-medium">Or sign up with email</span>
            <div className="flex-1 border-t border-white/10"></div>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              ...
              <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Manas Singh" className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 outline-none focus:border-purple-500/50 text-sm transition-colors" required />
            </div>
            <div>
