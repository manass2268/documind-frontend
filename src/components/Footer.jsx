        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-white p-1.5 rounded-sm">
                <img src={ashokaLogo} alt="Satyameva Jayate" className="h-10 sm:h-12 object-contain" />
              </div>
            ...
            <div className="flex flex-col space-y-3 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-400 hover:text-white transition-colors cursor-pointer">support.mstech4407@gmail.com</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm mb-6">
              <li><a href="#" className="flex items-center gap-2 hover:text-white transition-colors"><ShieldCheck size={14} className="text-gray-400"/> Privacy Policy</a></li>
