...
export default function Sidebar() {
  return (
    <div className="w-72 h-full backdrop-blur-xl bg-[#0A0A0F]/80 border-r border-white/10 p-5 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.5)]">
      ...
      <button className="w-full flex items-center gap-2 px-4 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl transition-all mb-8 text-sm font-medium cursor-pointer group text-white">
        <Plus size={18} className="text-cyan-400 group-hover:rotate-90 transition-transform duration-300" />
        New Chat
        <span className="ml-auto text-xs text-gray-500 border border-gray-700 px-1.5 py-0.5 rounded">⌘K</span>
      </button>
      ...
      <div className="mt-auto pt-4 border-t border-white/10">
        <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-white/5 cursor-pointer transition-colors text-white">
          <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-purple-600 to-cyan-600 flex items-center justify-center text-sm font-bold shadow-lg">
            MS
          </div>
          <div className="flex-1">
            <div className="text-sm font-medium">Manas Singh</div>
            <div className="text-xs text-cyan-400">Pro Plan</div>
          </div>
